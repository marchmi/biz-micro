  ...
  <div class="settings-page">
    ...
    <el-card class="sub-apps-config">
      ...
      <el-form :model="subAppConfig" label-width="120px">
        <el-form-item label="默认容器ID">
          <el-input v-model="subAppConfig.container" placeholder="#sub-app-container" />
        </el-form-item>
        <el-form-item label="预加载">
          <el-switch v-model="subAppConfig.prefetch" />
        </el-form-item>
        <el-form-item label="沙箱模式">
          <el-select v-model="subAppConfig.sandbox" placeholder="选择沙箱模式">
            <el-option label="严格隔离" value="strict" />
            <el-option label="实验性隔离" value="experimental" />
            <el-option label="关闭沙箱" value="disabled" />
          </el-select>
        </el-form-item>
        <el-form-item>
